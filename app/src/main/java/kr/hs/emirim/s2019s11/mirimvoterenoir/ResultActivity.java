...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int[] imageFileNames = {R.drawable.vote1, R.drawable.vote2, R.drawable.vote3, R.drawable.vote4, R.drawable.vote5, R.drawable.vote6, R.drawable.vote7, R.drawable.vote8, R.drawable.vote9};
